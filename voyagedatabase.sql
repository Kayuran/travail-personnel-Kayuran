...
INSERT INTO `hotel` (`idHOT`, `FK_idPRE`,`nom`, `rating`,`image`, `description`) VALUES
...
INSERT INTO `reservation` (`idRES`,`FK_idHOT`,`FK_idUSER`, `pays`, `periode`, `rating`,`image`, `description`, `lieu`, `nb_personne`) VALUES
